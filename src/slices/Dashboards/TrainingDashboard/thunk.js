import { ERP_GET_TrainingDashboard } from "../../../helpers/fakebackend_helper";
import { createAsyncThunk } from "@reduxjs/toolkit";

export const GET_TrainingDashboard = createAsyncThunk(
  "MainDashboard/post",
  async ({ FromDate, ToDate, existingData, filterArray }, thunkAPI) => {
    try {
      ...
      const response = ERP_GET_TrainingDashboard(bodyData);
